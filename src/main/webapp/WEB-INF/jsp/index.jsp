...
<body class="main_body">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="<c:url value='/static/plugin/images/face.jpg'/>" class="layui-circle" width="35" height="35">
							<cite>请叫我马哥</cite>
						</a>
			...
			<div class="layui-tab marg0" lay-filter="bodyTab">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="<c:url value='/static/plugin/page/main.html'/>"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="admin-header-lock" id="lock-box" style="display: none;">
		<div class="admin-header-lock-img"><img src="<c:url value='/static/plugin/images/face.jpg'/>"/></div>
	...
	<script type="text/javascript" src="<c:url value='/static/plugin/layui/layui.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/static/plugin/js/nav.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/static/plugin/js/leftNav.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/static/plugin/js/index.js'/>"></script>
</body>
</html>
