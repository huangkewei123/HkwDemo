...
public abstract class WebUtils {
	...
	public static String doPost(String url, String content, String charset, int connectTimeout,
			int readTimeout, Map<String, String> headerMap) throws IOException {
		String ctype = "application/json;charset=" + charset;
		return _doPost(url, ctype, content.getBytes(charset), connectTimeout, readTimeout, headerMap);
	}
	
	public static String doPut(String url, Map<String, String> params, String charset, int connectTimeout,
			int readTimeout) throws IOException {
		return doPut(url, params, charset, connectTimeout, readTimeout, null);
	}
	public static String doPut(String url, Map<String, String> params, String charset, int connectTimeout,
			int readTimeout, Map<String, String> headerMap) throws IOException {
		String ctype = "application/x-www-form-urlencoded;charset=" + charset;
		...
		return _doPut(url, ctype, content, connectTimeout, readTimeout, headerMap);
	}
	/**
	 * 执行HTTP POST请求。
	 * 
	...
	private static String _doPut(String url, String ctype, byte[] content, int connectTimeout, int readTimeout,
			Map<String, String> headerMap) throws IOException {
		HttpURLConnection conn = null;
		OutputStream out = null;
		String rsp = null;
