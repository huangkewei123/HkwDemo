...
import com.example.demo.jee.exception.SubException;
...
public class HttpHelper {
	 ...
	 */
	public static JSONObject doCommHttp(RequestType reqType, String url, String paramStr) throws SubException {
	...
	public static JSONObject doUploadHttp(RequestType reqType, String url, byte[] param, String contentMd5,
                                          String contentType) throws SubException {
